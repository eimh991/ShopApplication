...
-- BalanceHistory
INSERT INTO public."BalanceHistory" ("BalanceHistoryId", "Amount", "Description", "TransactionDate", "UserId") VALUES
...
-- Cart
INSERT INTO public."Cart" ("CartId", "UserId") VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4);
...
-- OrderItems
INSERT INTO public."OrderItems" ("OrderItemId", "Quantity", "UnitPrice", "OrderId", "ProductId") VALUES
(4, 3, 294, 4, 11),
(5, 2, 3000, 4, 14),
(6, 5, 570, 4, 12),
(7, 1, 114, 5, 12),
...
-- Orders
INSERT INTO public."Orders" ("OrderId", "OrderDate", "TotalAmount", "UserId") VALUES
...
-- Products
INSERT INTO public."Products" ("ProductId", "Name", "Description", "Price", "Stock", "ImagePath", "CategoryId") VALUES
...
(6, 'Джинсы Levis', 'Slime 511', 8700, 12, 'default.jpg', 5),
...
-- TopUpCodes
INSERT INTO public."TopUpCodes" ("TopUpCodeId", "Code", "Amount", "IsUsed", "CreatedAt", "UsedByUserId") VALUES
(1, '1016A2858DFF', 500, false, '2025-05-28 19:04:00.708463+03', NULL),
(2, 'A0577558FFC5', 2000, false, '2025-05-28 19:27:39.234873+03', NULL);

-- Users
INSERT INTO public."Users" ("UserId", "UserName", "Email", "PasswordHash", "Balance", "UserRole") VALUES
